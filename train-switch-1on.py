...
wandb.init(entity="amudide", project="Switch (1 Always On)", config={f'{trainer_config["wandb_name"]}-{i}' : trainer_config for i, trainer_config in enumerate(trainer_configs)})
