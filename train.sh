python train-relu.py --gpu 2 --l1_penalties 5 6.46
python train-relu.py --gpu 3 --l1_penalties 8.34 10.78
python train-relu.py --gpu 4 --l1_penalties 13.92 17.98
python train-relu.py --gpu 5 --l1_penalties 23.23 30

python train-gated.py --gpu 0 --l1_penalties 10 13.20
python train-gated.py --gpu 1 --l1_penalties 17.43 23.01
